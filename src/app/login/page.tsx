          ...
          <div className="px-8 py-8">
            ...
            <div className="mt-6 p-4 bg-amber-50 border border-amber-100 rounded-xl">
              ...
              <div className="space-y-1 text-xs text-amber-600">
                <p><span className="font-medium">Admin:</span> admin@priyadarsani.com / Admin@123</p>
                <p><span className="font-medium">Teacher:</span> prem.sir@priyadarsani.com / Teacher@123</p>
